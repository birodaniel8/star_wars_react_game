...
with open("planets.json") as json_file:
    ...
    for item in data["items"]:
        try:
            ...
            if name == "Stewjon":
                image_url = "https://holopedia.de/thumb.php?f=PlanetStewjon.jpg&width=250"
            elif name == "Tholoth":
                image_url = "https://res.cloudinary.com/dmbf29/image/upload/v1573288037/cjbliu5otyakjohtobxn.jpg"
            elif name == "Zolan":
                image_url = "https://static.wikia.nocookie.net/starwars/images/6/66/Zolan.jpg/revision/latest/scale-to-width-down/500?cb=20070701111500"
            else:
